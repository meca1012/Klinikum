...
public class SesameServiceTest {
    ...
    public static JavaArchive createDeployment() {
        ...
        return ShrinkWrap.create(JavaArchive.class).addClass(PatientServiceImpl.class)
                .addClass(ConceptServiceImpl.class).addClass(NoteServiceImpl.class).addClass(SesameServiceImpl.class)
                .addClass(LuceneServiceImpl.class).addClass(SesameTripleStore.class)
     ...
     * 
     * @throws Exception
     *             if PropertyLoader can not open property-files
     */
    @Test
    ...
    public void executeSPARQLQueryTest() throws Exception {
        ...
        String sparqlQuery = "SELECT ?Uri WHERE {?Uri <http://spironto.de/spironto#has-patient-number>"
