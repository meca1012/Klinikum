 ...
 * 
 *         This test was implemented to check our XML-syntax
 * 
 */
public class XMLTests {
    ...
    public void generateXML() throws JAXBException {
        Address address = new Address("de.spironto/address/" + "432432", "Hauptstrass", "12", "Karlsruhe", "432433",
                "Deutschland", "081511833");
